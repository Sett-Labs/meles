...
Like all modules in meles, you can get a list of available commands using ?, in this case `i2c:?`.
...
Now meles determines the 'return' based on the total amount of bits. Read bytes will be split to
