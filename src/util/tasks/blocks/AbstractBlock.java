...
public abstract class AbstractBlock {
    ...
    protected AbstractBlock next, altRoute, errorRoute;
    protected String id = "";
    ...
    public void setErrorRouteBlock(AbstractBlock errorRoute) {
        this.errorRoute = errorRoute;
    }

    protected void doErrorRoute(boolean tagAsFailure) {
        if (tagAsFailure)
            sendCallback(id() + " -> FAILURE");
        if (errorRoute != null)
            errorRoute.start();
    ...
    public String type(){ return "AbstractBlock";}
