...
/**
 * Extension for the I2CDevice class that adds meles relevant functionality
 */
public class I2cOpper extends I2cDevice{
	...
	public void useBus(EventLoopGroup scheduler){
		...
		if (res == -1) { // Means this was the last one in the set
            ...
            var set = ops.get(setId);
			forwardData( (set.isAscii()?"":(id + ";")) + set.getResult());
